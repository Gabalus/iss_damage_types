...
public class Config {
    ...
    private static final ModConfigSpec.DoubleValue SHIELD_BASH_BLOCKED_PCT = BUILDER
            .comment("Extra bash damage as a fraction of the last blocked damage (0.25 = +25%).")
    ...
    private static final ModConfigSpec.IntValue STUN_GAUGE_DECAY_DELAY_TICKS = BUILDER
            .comment("Delay before stun gauge begins to decay (in ticks). 80 = 4 seconds.")
            .defineInRange("stun.gaugeDecayDelayTicks", 80, 0, 20 * 60);
